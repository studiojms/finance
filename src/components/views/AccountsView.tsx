          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-1">
                <button onClick={() => onEditAccount(account)} className="p-2 text-slate-400 hover:text-emerald-500">
                  <Edit2 size={18} />
                </button>
                <button onClick={() => onDeleteAccount(account)} className="p-2 text-slate-400 hover:text-rose-500">
                  <Trash2 size={18} />
                </button>
              </div>
            </div>
